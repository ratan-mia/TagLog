                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="thumb-content m-t-15">
                                                    @if($result->logo)<a
                                                        href="{{ route('employer', [$result->id]) }}"><img
                                                            class="card-img-top img-fluid"
                                                            src="{{ $result->logo->getUrl() }}"></a>@endif
                                                </div>
                                            </div>
                                            <div class="col-md-4 border-right">
                                                ...
                                                <p class="title-attr">Location:<span>{{$result->city->name}}</span> <a
                                                        class="link-map" href="{{ route('agent', [$result->id]) }}">
                                                        See Map
                                                    </a></p>
                                                {{--                                            <h3 class="sub-title-attr">Overview</h3>--}}

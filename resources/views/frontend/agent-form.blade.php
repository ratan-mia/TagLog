    ...
    <div class="form-row">
        <div class="form-group col-md-2 offset-md-1">
            ...
            <select
                ...
                <option value {{ old('destination_id', null) === null ? 'selected' : '' }}>{{ trans('Destination(Japan only)') }}</option>
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control {{ $errors->has('visa_type') ? 'is-invalid' : '' }}"
                ...
                <option value  {{ old('visa_type', null) === null ? 'selected' : '' }}>{{ trans('Visa Type') }}</option>
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control {{ $errors->has('country_id') ? 'is-invalid' : '' }}"
                ...
                <option value  {{ old('country_id', null) === null ? 'selected' : '' }}>{{ trans('forms.country') }}</option>
        ...
        <div class="form-group col-md-2">
            ...
            <select class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }}"
                ...
                <option value {{ old('city_id', null) === null ? 'selected' : '' }}>{{ trans('forms.city') }}</option>

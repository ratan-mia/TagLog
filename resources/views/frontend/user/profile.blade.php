                                    ...
                                    <!--Sending Organization-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                value="{{ old('agent_rating', $experience->agent_rating) }}" step="1">
                                        ...
                                        {{--                                        <div class="form-group">--}}
                                        {{--                                            <label--}}
                                        {{--                                                for="destination_id">{{ trans('cruds.experience.fields.destination') }}</label>--}}
                                        {{--                                            <select--}}
                                        ...
                                        {{--                                                    <option--}}
                                        {{--                                                        value="{{ $id }}" {{ ($experience->destination ? $experience->destination->id : old('destination_id')) == $id ? 'selected' : '' }}>{{ $destination }}</option>--}}
                                        {{--                                                @endforeach--}}
                                        {{--                                            </select>--}}
                                        ...
                                        {{--                                            @endif--}}
                                        {{--                                            <span--}}
                                        {{--                                                class="help-block">{{ trans('cruds.experience.fields.destination_helper') }}</span>--}}
                                        {{--                                        </div>--}}
                                        {{--                                        <div class="form-group">--}}

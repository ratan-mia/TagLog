...
{{--                                <input type="text" name="destination" value="{{ old('destination') }}" class="form-control" placeholder="Destination" />--}}
                                ...
                                <select class="form-control {{ $errors->has('destination') ? 'is-invalid' : '' }}" name="destination" id="destination">
                                    ...
                                    @foreach(App\Country::all() as $key => $label)
                                        <option value="{{ $label->id }}" {{ old('destination', '') === (string) $label->id ? 'selected' : '' }}>{{ $label->name }}</option>
                                    @endforeach
                            ...
                            <div class="form-group col-md-">
                                <select name="country" class="form-control form-control-lg" placeholder="Country">

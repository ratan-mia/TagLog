...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.destinations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.destination.fields.country') }}</label>
                <select class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country" id="country">
                    ...
                    @foreach(App\Country::all() as $key => $label)
                        <option value="{{ $label->id }}" {{ old('country', '') === (string) $label->id ? 'selected' : '' }}>{{ $label->name }}</option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" name="language" id="language">
                    ...
                    @foreach(App\Language::all() as $key => $label)
                        <option value="{{ $key }}" {{ old('language', '') === (string) $key ? 'selected' : '' }}>{{ $label->value }}</option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('currency') ? 'is-invalid' : '' }}" name="currency" id="currency">
                    ...
                    @foreach(App\Currency::all() as $key => $label)
                        <option value="{{ $key }}" {{ old('currency', '') === (string) $key ? 'selected' : '' }}>{{ $label->name }}</option>
                    @endforeach
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('industries') ? 'is-invalid' : '' }}" name="industries" id="industries">
                    ...
                    @foreach(App\Destination::INDUSTRIES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('industries', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('employers') ? 'is-invalid' : '' }}" type="text" name="employers" id="employers" value="{{ old('employers', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('agents') ? 'is-invalid' : '' }}" name="agents" id="agents">
                    ...
                    @foreach(App\Destination::AGENTS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('agents', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hourly_salary') ? 'is-invalid' : '' }}" type="number" name="hourly_salary" id="hourly_salary" value="{{ old('hourly_salary') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('yearly_salary') ? 'is-invalid' : '' }}" type="text" name="yearly_salary" id="yearly_salary" value="{{ old('yearly_salary', '') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Destination::SAFE_MEDICINE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('safe_medicine') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="safe_medicine_{{ $key }}" name="safe_medicine" value="{{ $key }}" {{ old('safe_medicine', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('healthcare') ? 'is-invalid' : '' }}" name="healthcare" id="healthcare">{{ old('healthcare') }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Destination::TAXI_AVAILABLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('taxi_available') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="taxi_available_{{ $key }}" name="taxi_available" value="{{ $key }}" {{ old('taxi_available', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('safety') ? 'is-invalid' : '' }}" name="safety" id="safety">{{ old('safety') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('culture') ? 'is-invalid' : '' }}" name="culture" id="culture">{!! old('culture') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('politics') ? 'is-invalid' : '' }}" name="politics" id="politics">{{ old('politics') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('insurance') ? 'is-invalid' : '' }}" name="insurance" id="insurance">{{ old('insurance') }}</textarea>

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.industries.update", [$industry->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $industry->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $industry->description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_salary') ? 'is-invalid' : '' }}" type="number" name="minimum_salary" id="minimum_salary" value="{{ old('minimum_salary', $industry->minimum_salary) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maximum_salary') ? 'is-invalid' : '' }}" type="number" name="maximum_salary" id="maximum_salary" value="{{ old('maximum_salary', $industry->maximum_salary) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('education_level') ? 'is-invalid' : '' }}" name="education_level" id="education_level">
                    ...
                    @foreach(App\Industry::EDUCATION_LEVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('education_level', $industry->education_level) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('training_level') ? 'is-invalid' : '' }}" name="training_level" id="training_level">
                    ...
                    @foreach(App\Industry::TRAINING_LEVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('training_level', $industry->training_level) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Industry::LANGUAGE_COURSE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('language_course') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="language_course_{{ $key }}" name="language_course" value="{{ $key }}" {{ old('language_course', $industry->language_course) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('language_course_level') ? 'is-invalid' : '' }}" name="language_course_level" id="language_course_level">
                    ...
                    @foreach(App\Industry::LANGUAGE_COURSE_LEVEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('language_course_level', $industry->language_course_level) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('banner_titile') ? 'is-invalid' : '' }}" type="text" name="banner_titile" id="banner_titile" value="{{ old('banner_titile', $industry->banner_titile) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('banner_text') ? 'is-invalid' : '' }}" name="banner_text" id="banner_text">{!! old('banner_text', $industry->banner_text) !!}</textarea>

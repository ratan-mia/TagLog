    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.comments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comment_type') ? 'is-invalid' : '' }}" type="text" name="comment_type" id="comment_type" value="{{ old('comment_type', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('commenter') ? 'is-invalid' : '' }}" name="commenter_id" id="commenter_id">
                    @foreach($commenters as $id => $commenter)
                        <option value="{{ $id }}" {{ old('commenter_id') == $id ? 'selected' : '' }}>{{ $commenter }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commentable_type') ? 'is-invalid' : '' }}" type="text" name="commentable_type" id="commentable_type" value="{{ old('commentable_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commentable') ? 'is-invalid' : '' }}" type="text" name="commentable" id="commentable" value="{{ old('commentable', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('approved') ? 'is-invalid' : '' }}" type="number" name="approved" id="approved" value="{{ old('approved') }}" step="1">

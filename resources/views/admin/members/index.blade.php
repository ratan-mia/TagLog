            ...
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-Member">
                    ...
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.member.fields.position') }}
                        </th>
                        <th>
                            {{ trans('cruds.member.fields.facebook') }}
                        </th>
                        <th>
                            {{ trans('cruds.member.fields.twitter') }}
                        </th>
                        <th>
                            {{ trans('cruds.member.fields.instagram') }}
                        </th>
                        <th>
                            ...
                            <td>
                                @if($member->photo)
                                    <a href="{{ $member->photo->getUrl() }}" target="_blank">
                                        <img src="{{ $member->photo->getUrl('thumb') }}" width="50px" height="50px">
                                    </a>
                                @endif
                            </td>
                            <td>

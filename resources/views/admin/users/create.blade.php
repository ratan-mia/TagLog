        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('education_level') ? 'is-invalid' : '' }}"
                        ...
                        @foreach(App\User::EDUCATION_LEVEL_SELECT as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('education_level', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('language_level') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('destination_area') ? 'is-invalid' : '' }}" type="text"
                           name="destination_area" id="destination_area" value="{{ old('destination_area', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('visa_type') ? 'is-invalid' : '' }}" name="visa_type"
                            id="visa_type">
                        <option value
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('industries') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($industries as $id => $industries)
                            <option
                                value="{{ $id }}" {{ in_array($id, old('industries', [])) ? 'selected' : '' }}>{{ $industries }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('expected_salary') ? 'is-invalid' : '' }}" type="number"
                           name="expected_salary" id="expected_salary" value="{{ old('expected_salary') }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('date_of_leaving') ? 'is-invalid' : '' }}"
                           type="text" name="date_of_leaving" id="date_of_leaving" value="{{ old('date_of_leaving') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('employer') ? 'is-invalid' : '' }}"

            ...
            <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('facebook') ? 'is-invalid' : '' }}" type="text"
                           name="facebook" id="facebook" value="{{ old('facebook', $user->facebook) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('skype') ? 'is-invalid' : '' }}" type="text" name="skype"
                           id="skype" value="{{ old('skype', $user->skype) }}">
                    @if($errors->has('skype'))
                        <div class="invalid-feedback">
                            {{ $errors->first('skype') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('visa_type') ? 'is-invalid' : '' }}" name="visa_type"
                        ...
                        @foreach($visas as $key => $label)
                            <option
                                value="{{ $key }}" {{ old('visa_type', $user->visa_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('expected_salary') ? 'is-invalid' : '' }}" type="number"
                           ...
                           value="{{ old('expected_salary', $user->expected_salary) }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('employer') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($employers as $id => $employer)
                            <option
                                value="{{ $id }}" {{ ($user->employer ? $user->employer->id : old('employer_id')) == $id ? 'selected' : '' }}>{{ $employer }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('agents') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($agents as $id => $agents)
                            <option
                                value="{{ $id }}" {{ ($user->agents ? $user->agents->id : old('agents_id')) == $id ? 'selected' : '' }}>{{ $agents }}</option>
                        @endforeach
                    </select>

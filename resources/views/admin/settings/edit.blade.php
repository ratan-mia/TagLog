    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $setting->url) }}">
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('philosophy_title') ? 'is-invalid' : '' }}" type="text" name="philosophy_title" id="philosophy_title" value="{{ old('philosophy_title', $setting->philosophy_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('philosophy_sentence') ? 'is-invalid' : '' }}" name="philosophy_sentence" id="philosophy_sentence">{!! old('philosophy_sentence', $setting->philosophy_sentence) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mission_title') ? 'is-invalid' : '' }}" type="text" name="mission_title" id="mission_title" value="{{ old('mission_title', $setting->mission_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('mission_sentence') ? 'is-invalid' : '' }}" name="mission_sentence" id="mission_sentence">{!! old('mission_sentence', $setting->mission_sentence) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_title') ? 'is-invalid' : '' }}" type="text" name="business_title" id="business_title" value="{{ old('business_title', $setting->business_title) }}">

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.agents.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('interview_period') ? 'is-invalid' : '' }}" name="interview_period" id="interview_period">
                    ...
                    @foreach(App\Agent::INTERVIEW_PERIOD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('interview_period', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_expense') ? 'is-invalid' : '' }}" type="number" name="total_expense" id="total_expense" value="{{ old('total_expense') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('destinations') ? 'is-invalid' : '' }}" name="destinations[]" id="destinations" multiple>
                    @foreach($destinations as $id => $destination)
                        <option value="{{ $id }}" {{ in_array($id, old('destinations', [])) ? 'selected' : '' }}>{{ $destination }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('employers') ? 'is-invalid' : '' }}" name="employers[]" id="employers" multiple>
                    @foreach($employers as $id => $employers)
                        <option value="{{ $id }}" {{ in_array($id, old('employers', [])) ? 'selected' : '' }}>{{ $employers }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('leaving_period') ? 'is-invalid' : '' }}" name="leaving_period" id="leaving_period">
                    ...
                    @foreach(App\Agent::LEAVING_PERIOD_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('leaving_period', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('workers_sent') ? 'is-invalid' : '' }}" type="number" name="workers_sent" id="workers_sent" value="{{ old('workers_sent') }}" step="1">

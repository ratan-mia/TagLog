    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.countries.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('religion') ? 'is-invalid' : '' }}" name="religion" id="religion">{{ old('religion') }}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Country::SAFE_FOOD_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('safe_food') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="safe_food_{{ $key }}" name="safe_food" value="{{ $key }}" {{ old('safe_food', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('food') ? 'is-invalid' : '' }}" name="food" id="food">{!! old('food') !!}</textarea>
                @if($errors->has('food'))
                    <div class="invalid-feedback">
                        {{ $errors->first('food') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('health_insurance') ? 'is-invalid' : '' }}" name="health_insurance" id="health_insurance">{!! old('health_insurance') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('healthcare') ? 'is-invalid' : '' }}" name="healthcare" id="healthcare">{!! old('healthcare') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('transport') ? 'is-invalid' : '' }}" name="transport" id="transport">{!! old('transport') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('politics') ? 'is-invalid' : '' }}" name="politics" id="politics">{!! old('politics') !!}</textarea>

            ...
            <form method="POST" action="{{ route("admin.employers.update", [$employer->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                           id="name" value="{{ old('name', $employer->name) }}">
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email"
                           id="email" value="{{ old('email', $employer->email) }}" required>
                    @if($errors->has('email'))
                        <div class="invalid-feedback">
                            {{ $errors->first('email') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone"
                           id="phone" value="{{ old('phone', $employer->phone) }}">
                    @if($errors->has('phone'))
                        <div class="invalid-feedback">
                            {{ $errors->first('phone') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text"
                           name="address" id="address" value="{{ old('address', $employer->address) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('latitude') ? 'is-invalid' : '' }}" type="text"
                           name="latitude" id="latitude" value="{{ old('latitude', $employer->location->latitude) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('longitude') ? 'is-invalid' : '' }}" type="text"
                           ...
                           value="{{ old('longitude', $employer->location->longitude) }}">
                ...
                <div class="form-group {{ $errors->has('city_id') ? 'has-error' : '' }}">
                    ...
                    <select name="city_id" id="city" class="form-control select2">
                        @foreach($cities as $id => $city)
                            <option
                                value="{{ $id }}" {{ (isset($employer) && $employer->city ? $employer->city->id : old('city_id')) == $id ? 'selected' : '' }}>{{ $city }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}"
                              name="description"
                              id="description">{!! old('description', $employer->description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('destinations') ? 'is-invalid' : '' }}"
                            name="destinations[]" id="destinations" multiple>
                        @foreach($destinations as $id => $destinations)
                            <option
                                value="{{ $id }}" {{ (in_array($id, old('destinations', [])) || $employer->destinations->contains($id)) ? 'selected' : '' }}>{{ $destinations }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('recruiting_workers') ? 'is-invalid' : '' }}"
                           type="number" name="recruiting_workers" id="recruiting_workers"
                           value="{{ old('recruiting_workers', $employer->recruiting_workers) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('agents') ? 'is-invalid' : '' }}"
                            name="agents[]" id="agents" multiple>
                        @foreach($agents as $id => $agents)
                            <option
                                value="{{ $id }}" {{ (in_array($id, old('agents', [])) || $employer->agents->contains($id)) ? 'selected' : '' }}>{{ $agents }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('industries') ? 'is-invalid' : '' }}"
                        ...
                        @foreach($industries as $id => $industries)
                            <option
                                value="{{ $id }}" {{ (in_array($id, old('industries', [])) || $employer->industries->contains($id)) ? 'selected' : '' }}>{{ $industries }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('visas') ? 'is-invalid' : '' }}" name="visas[]"
                            id="visas" multiple>
                        @foreach($visas as $id => $visa)
                            <option
                                value="{{ $id }}" {{ (in_array($id, old('visas', [])) || $employer->visas->contains($id)) ? 'selected' : '' }}>{{ $visa }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('visas'))
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('monthly_salary') ? 'is-invalid' : '' }}" type="number"
                           name="monthly_salary" id="monthly_salary"
                           value="{{ old('monthly_salary', $employer->monthly_salary) }}" step="0.01">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('working_hours') ? 'is-invalid' : '' }}" type="number"
                           ...
                           value="{{ old('working_hours', $employer->working_hours) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('days_off') ? 'is-invalid' : '' }}" type="number"
                           name="days_off" id="days_off" value="{{ old('days_off', $employer->days_off) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('banner_titile') ? 'is-invalid' : '' }}" type="text"
                           name="banner_titile" id="banner_titile"
                           value="{{ old('banner_titile', $employer->banner_titile) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('banner_text') ? 'is-invalid' : '' }}"
                              name="banner_text"
                              id="banner_text">{!! old('banner_text', $employer->banner_text) !!}</textarea>

...
return [
    ...
    'user' => [
        ...
        'fields' => [
            ...
            'country_helper' => '',
            'nationality_helper' => '',
            'city' => 'Area Currently You\'re Living',
            ...
            'destination_area_helper' => '',
            'destination_helper' => '',
            'visa_type_sign_up' => 'Visa Type You\'re Looking for',
            'visa_type' => 'Visa Type You\'re Looking for',
            'visa_type_helper' => '',
            ...
            'date_of_leaving' => 'Expected date of start working',
            'date_of_leaving_register' => 'Expected date of start working',
            'date_of_leaving_helper' => '',
            'employer' => 'Employer',
            'employer_helper' => '',
            'agents' => 'Name of Sending Organization',
            'agents_register' => 'Name of Sending Organization',
            'agents_helper' => '',
            'indurstry' => 'Indurstry',
            'indurstry_helper' => '',
    ...
    'setting' => [
        ...
        'fields' => [
            ...
            'mission_title_helper' => '',
            'philosophy_sentence' => 'Philosophy Sentence',
            'philosophy_sentence_helper' => '',
            'mission_sentence' => 'Mission Sentence',
            'mission_sentence_helper' => '',
    ...
    'interview'      => [
        ...
        'title_singular' => 'Interview Schedule',
        'fields'         => [
            'id'                       => 'ID',
            'id_helper'                => '',
            'visa_type'                => 'Visa Type',
            ...
            'result'                   => 'Result',
            'result_helper'            => '',
            'contact_to_taglog'        => 'Contact To TagLog',
            'contact_to_taglog_helper' => '',
            'created_at'               => 'Created at',
            'created_at_helper'        => '',
            'updated_at'               => 'Updated at',
            'updated_at_helper'        => '',
    ...
    'experience' => [
        ...
        'fields' => [
            ...
            'user' => 'User',
            'user_helper' => '',
            'agent' => 'Name of Sending Organization',
            'agent_helper' => '',
            'destination' => 'Destination Country',
            'destination_helper' => '',
            'visa_type' => 'Visa Type',
            ...
            'expenses_paid' => 'Expenses paid to  Agency',
            'visa_application_rating' => 'Satisfaction Rating about Visa Application',
            'visa_application_rating_helper' => '',
            'language_training_rating' => 'Satisfaction Rating about Language Training',
            'language_training_rating_helper' => '',
            ...
            'employer_rating' => 'Satisfaction Rating about Employer(Min0-10Max)',
